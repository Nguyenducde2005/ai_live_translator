...
export default function EditSlackAppPage() {
  ...
  const fetchSlackApp = async () => {
    try {
      ...
      setError(err.response?.data?.message || 'Failed to fetch Slack app')
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to update Slack app')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6 flex items-center">
            ...
            Slack app updated successfully! Redirecting...
          </div>
        )}
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Edit Slack App</h1>
                  <p className="text-gray-600">Update your existing Slack app for translation bot</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200 mt-8">
              ...
              >
                ...
                <span>{isLoading ? 'Updating Slack App...' : 'Update Slack App'}</span>
              </Button>
            </div>
          </form>
        </div>
